...
class Player {
    ...
    update() {
        ...
        if (isPointerLocked) {
            angleY -= movedX * 0.002; // Yaw rotation
            angleX -= movedY * 0.002; // Pitch rotation
        ...
        // this.rotation.x = this.rotation.x + radius * sin(angleY) * cos(angleX);
        // this.rotation.y = this.rotation.y + radius * sin(angleX);
        // this.rotation.z = this.rotation.z + radius * cos(angleY) * cos(angleX);
